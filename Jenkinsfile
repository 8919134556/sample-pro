    ...
    stages {
        ...
        stage('Deploy to Dev Server') {
            ...
            steps {
                ...
                sh "ansible-playbook -i ${WORKSPACE}/inventory.ini ${WORKSPACE}/dev_deploy.yml -e branch=${BRANCH_NAME}"
            }
        }
        ...
        stage('Deploy to Prod Server') {
            ...
            steps {
                ...
                sh "ansible-playbook -i ${WORKSPACE}/inventory.ini ${WORKSPACE}/prod_deploy.yml -e branch=${BRANCH_NAME}"
            }
        }
    }
}
