    ...
    stages {
        ...
        stage('Deploy to Dev Server') {
            ...
            steps {
                ...
                sh "ansible-playbook -i ${WORKSPACE}/inventory.ini ${WORKSPACE}/deploy-dev.yml -e branch=${BRANCH_NAME}"
            }
        }
        ...
        stage('Deploy to Prod Server') {
            ...
            steps {
                ...
                sh "ansible-playbook -i ${WORKSPACE}/inventory.ini ${WORKSPACE}/deploy-prod.yml -e branch=${BRANCH_NAME}"
            }
        }
    }
}
